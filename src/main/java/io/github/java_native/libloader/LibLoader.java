...
/**
 * Default entrypoint for users.
 */
public class LibLoader {

    public static NativeLibLoader getLibLoader() {
        return new ExtensibleNativeLibLoader(new DefaultLibLoaderConfig());
    }

    public static NativeLibLoader getLibLoader(final LibLoaderConfig config) {
        return new ExtensibleNativeLibLoader(config);
    }
